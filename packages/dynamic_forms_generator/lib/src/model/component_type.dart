...
class GenericType extends ComponentType {
  ...
  GenericType(String typeName, bool isNullable, this.genericParameters) : super(typeName, isNullable);
...
class ArrayType extends ComponentType {
  ...
  ArrayType(this.innerType, bool isNullable) : super(innerType.typeName, isNullable);
...
class GenericParameterType extends ComponentType {
  ...
  GenericParameterType(String typeName, bool isNullable, [this.extendsType]) : super(typeName, isNullable);
...
class DefinitionType extends ComponentType {
  DefinitionType(String typeName, bool isNullable) : super(typeName, isNullable);
...
class GenericDefinitionType extends DefinitionType {
  ...
  GenericDefinitionType(String typeName, bool isNullable, this.genericParameters)
